        ...
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-zinc-400">
              ...
              aby zobaczyć szczegóły i od razu ją zarezerwować.
            </p>
          </div>
          <a
            href="#"
            ...
            filteredBooks.map((book) => (
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-zinc-950">
                  ...
                  <Link
                    href={`/book/${book.id}`}
                    className="absolute bottom-3 left-1/2 z-10 flex min-h-[44px] -translate-x-1/2 items-center justify-center rounded-full bg-sue px-4 py-2 text-xs font-semibold text-white transition-all hover:bg-sue-deep sm:translate-y-3 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100"
                  >
                    Zobacz i zarezerwuj
                  </Link>
                </div>
