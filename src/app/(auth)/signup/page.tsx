    ...
    <Card className="mx-auto w-full max-w-md border-zinc-800 bg-zinc-900/60 backdrop-blur-xl">
      <CardHeader className="text-center px-4 sm:px-6">
        <Link href="/" className="mx-auto mb-4 flex items-center gap-2">
          ...
          <span className="font-display text-xl font-bold text-white">SUE</span>
        </Link>
        <CardTitle className="font-display text-2xl text-white">
          Utwórz konto
        </CardTitle>
        <CardDescription className="text-zinc-400">
          Dołącz do giełdy podręczników w swojej szkole
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4 px-4 sm:px-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-zinc-900/60 px-2 text-zinc-500">lub</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-zinc-400">
          Masz już konto?{' '}
          <Link href="/login" className="font-medium text-sue hover:underline">
            Zaloguj się
          </Link>
        </p>
      </CardContent>
